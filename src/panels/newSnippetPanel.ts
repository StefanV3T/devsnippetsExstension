...
export class NewSnippetPanel {
  public static currentPanel: NewSnippetPanel | undefined;
  ...
  public static createOrShow(
    ...
    NewSnippetPanel.currentPanel = new NewSnippetPanel(
      panel,
      extensionUri,
      snippetManager,
      initialData
  ...
  private _saveSnippet(snippetData: any, id?: string) {
    try {
  ...
  private _update(initialData?: Partial<Snippet>) {
  ...
  private _getHtmlForWebview(webview: vscode.Webview, initialData?: Partial<Snippet>): string {
